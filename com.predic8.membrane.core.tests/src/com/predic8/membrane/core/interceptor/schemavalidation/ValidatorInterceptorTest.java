...
public class ValidatorInterceptorTest {
	...
	public void testSchemaValidation() throws Exception {
		assertEquals(Outcome.CONTINUE, getOutcome(requestTB, createSchemaValidatorInterceptor("resources/validation/order.xsd"), "/validation/order.xml"));
		assertEquals(Outcome.ABORT, getOutcome(requestTB, createSchemaValidatorInterceptor("resources/validation/order.xsd"), "/validation/invalid-order.xml"));
	}
