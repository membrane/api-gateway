...
homeSet() {
 ...
 java  -classpath "$CLASSPATH" com.predic8.membrane.core.Starter -c car-schematron.proxies.xml -b ../../../conf/monitor-beans.xml
 
}

terminate() {
	echo "Starting of Membrane Router failed."
	echo "Please execute this script from the MEMBRANE_HOME/examples/validation/schematron directory"
