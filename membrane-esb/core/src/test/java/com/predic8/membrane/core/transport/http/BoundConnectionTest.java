...
public class BoundConnectionTest {
	...
	public void setUp() throws Exception {
		...
		ServiceProxy sp1 = new ServiceProxy(new ServiceProxyKey("*",
				"*", ".*", 3021), "localhost", 3022);
		router.getRuleManager().addProxyIfNew(sp1);
	...
	public void testBinding() throws Exception {
		...
		try {
			c = Connection.open(InetAddress.getByName("localhost"), 3021, null, null);
			...
			c2 = Connection.open(InetAddress.getByName("localhost"), 3021, null, null);
