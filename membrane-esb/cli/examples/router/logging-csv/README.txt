...
Using the StatisticsCSVInterceptor, Membrane Monitor and Router can log access data to a file. The fields will be separated by semicolon (;), so that you can import the data into Excel.
