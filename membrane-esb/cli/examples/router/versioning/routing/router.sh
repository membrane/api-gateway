...
homeSet() {
 ...
 java  -classpath "$CLASSPATH" com.predic8.membrane.core.Starter -c versioning-routing.proxies.xml -b ../../../conf/monitor-beans.xml
 
}

terminate() {
	echo "Starting of Membrane Router failed."
	echo "Please execute this script from the MEMBRANE_HOME/examples/versioning/routing directory"
