...
REM ---------------------- Client ----------------------------------------------
keytool -genkey -keyalg RSA -keysize 4096 -sigalg SHA256withRSA -storetype PKCS12 -alias client -keypass secret -keystore client.p12 -storepass secret -dname "cn=client"
