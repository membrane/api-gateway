...
## Start Membrane using Docker

If you want to start membrane using Docker use the `docker.sh` script instead of the `membrane.sh`. Make sure to always
use the script next to the yamls.  
