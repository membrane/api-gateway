...
The 'Getting Started' tutorial takes about 15 minutes. After completing it, you will be able to set up the API Gateway and handle common API Gateway use cases.
