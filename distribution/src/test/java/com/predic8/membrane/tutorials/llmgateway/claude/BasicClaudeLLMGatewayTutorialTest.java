...
package com.predic8.membrane.tutorials.llmgateway.claude;

import com.predic8.membrane.tutorials.llmgateway.AbstractAiTutorialTest;
...
/**
 * Integration test for {@code distribution/tutorials/llm-gateway/claude/10-Basic-LLM-Gateway.yaml}.
 *
