...
public class CorsAllowAllTutorialTest extends AbstractCorsTutorialTest {

    @Override
    protected String getTutorialYaml() {
        return "10-CORS-Allow-All.yaml";
    }

    @Test
    void preflightForAnyMethodAndHeaderIsAnswered() {
        // @formatter:off
        given()
    ...
    @Test
    void responseCarriesAllowOrigin() {
        // @formatter:off
        given()
            .header("Origin", "https://example.com")
        .when()
