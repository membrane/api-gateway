...
3. Execute api-gateway.bat or api-gateway.sh
...
When we run the membrane using api-gateway.sh you can see that in the console that requests and responses are being intercepted by our custom interceptor.
