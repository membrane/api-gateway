...
public class StaxConverterInterceptor extends AbstractInterceptor implements XMLStreamConstants{
    ...
    public Outcome handleRequest(Exchange exc) throws Exception {
        if(exc.getRequestContentType().equals("application/xml")){
            this.replaceTag(exc.getRequest());
        }
    ...
    public Outcome handleResponse(Exchange exc) throws Exception {
        System.err.println("Inside handle response");
        System.err.println(exc.getResponse().getBodyAsStringDecoded());
        if(exc.getResponseContentType().equals("application/xml")){
            this.replaceTag(exc.getResponse());
        }
        return Outcome.CONTINUE;
    }
