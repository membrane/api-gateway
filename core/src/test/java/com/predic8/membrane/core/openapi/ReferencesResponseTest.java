...
public class ReferencesResponseTest {
    ...
    public void refRequestOk()  {
        ValidationErrors errors = validator.validate(Request.get().path("/ref-response")
                .body(getResourceAsStream("/openapi/references-requests-responses-customer.json")));
//        System.out.println("errors = " + errors);
    ...
    public void refResponseInvalid()  {
        ...
        ValidationErrors errors = validator.validateResponse(Request.get().path("/ref-response"), Response.statusCode(200).body(fis));
        System.out.println("errors = " + errors);
