...
public class GenericYamlParserTest {
    ...
    private static final Grammar GRAMMAR = new GrammarAutoGenerated();
    ...
    private static ErrCase err(String testName, String yaml, BeanRegistry reg) {
        return new ErrCase(testName, yaml, reg, RuntimeException.class);
    }
    ...
    private static APIProxy parse(String yaml, BeanRegistry reg) {
        return GenericYamlParser.parse(new ParsingContext("api", reg, GRAMMAR), APIProxy.class, parse(yaml));
    }
