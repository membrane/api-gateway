...
class GenericYamlParserMembraneTest {
    ...
    private static final K8sHelperGenerator K8S_HELPER = new K8sHelperGenerator() {
        @Override
        public Class<?> getElement(String key) {
            return K8sHelperGeneratorAutoGenerated.elementMapping.get(key);
        }

        @Override
        public Class<?> getLocal(String context, String key) {
            return K8sHelperGeneratorAutoGenerated.getLocal(context, key);
        }

        @Override
        public List<String> getCrdSingularNames() {
            return K8sHelperGeneratorAutoGenerated.crdSingularNames;
        }
    };
    ...
    private static APIProxy parse(String yaml, BeanRegistry reg) {
        return GenericYamlParser.parse("api", APIProxy.class, events(yaml), reg, K8S_HELPER);
    }
