...
//		script().attr("type","text/javascript").src("/admin/jquery/jquery-1.6.1.js").end();
		script().attr("type","text/javascript").src("https://code.jquery.com/jquery-1.12.4.js").end();
		script().attr("type","text/javascript").src("https://code.jquery.com/jquery-migrate-1.4.1.js").end();
