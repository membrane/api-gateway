...
public interface Interceptor {
	...
	/**
     * @return "accessControl" if <a href="https://membrane-soa.org/api-gateway-doc/current/configuration/reference/accessControl.htm">https://membrane-soa.org/api-gateway-doc/current/configuration/reference/accessControl.htm</a> is the documentation page
