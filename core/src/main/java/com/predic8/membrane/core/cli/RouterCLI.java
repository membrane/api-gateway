...
public class RouterCLI {
    ...
    private static @NotNull IRouter getRouter(MembraneCommandLine commandLine) {
        try {
    ...
    private static IRouter initRouterByOpenApiSpec(MembraneCommandLine commandLine) throws Exception {
