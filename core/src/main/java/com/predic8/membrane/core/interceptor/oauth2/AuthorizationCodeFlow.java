...
public class AuthorizationCodeFlow extends OAuth2Flow{

    public AuthorizationCodeFlow(OAuth2AuthorizationServerInterceptor authServer, Exchange exc, SessionManager.Session s) {
