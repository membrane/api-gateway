...
public class XmlContentFilterInterceptorParser extends AbstractParser {

	protected Class<?> getBeanClass(Element element) {
		return XMLContentFilterInterceptor.class;
	}

	@Override
	protected void doParse(Element element, BeanDefinitionBuilder builder) {
		setIdIfNeeded(element, "xmlContentFilter");
		
		setProperty(element, builder, "xPath");
	}
