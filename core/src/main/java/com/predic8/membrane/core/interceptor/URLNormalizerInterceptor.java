 ...
 *              root). The SOA model then combines "<a href="http://foo/material/ArticleService?wsdl">...</a>" and
 *              "./ArticleService?xsd=1" to "<a href="http://foo/material/./ArticleService?xsd=1">...</a>". This URI is sent to Membrane's
