 ...
 *
 * This class subclasses {@link groovy.text.StreamingTemplateEngine}, but unfortunately needs to
 * redeclare the inner class <code>groovy.text.StreamingTemplateEngine.StreamingTemplate</code>
 * because a) it's private and b) relevant parts of it cannot be adjusted by overriding specific
 * methods.
 *
...
public class StreamingTemplateEngine extends groovy.text.StreamingTemplateEngine {
    ...
    public Template createTemplate(final Reader reader) throws CompilationFailedException, ClassNotFoundException, IOException {
        return new StreamingTemplate(reader, StreamingTemplateEngine.class.getClassLoader());
    }
