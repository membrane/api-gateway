 ...
 * <p>See <a href="https://github.com/membrane/api-gateway/blob/master/distribution/tutorials/getting-started/70-Admin-Web-Console.yaml">tutorials/getting-started/70-Admin-Web-Console.yaml</a>.</p>
 * @yaml <pre><code>
 * api:
 *   port: 9000
 *   flow:
